...
using ValidationException = ExpressStore.Infrastructure.ValidationException;

namespace ExpressStore.Modules.Core.Data.EFCore
{
     public class CoreDbContext : IdentityDbContext<User, Role, long, IdentityUserClaim<long>, UserRole, IdentityUserLogin<long>, IdentityRoleClaim<long>, IdentityUserToken<long>>
    {
