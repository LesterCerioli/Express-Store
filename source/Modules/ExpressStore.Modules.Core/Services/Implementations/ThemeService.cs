...
namespace ExpressStore.Modules.Core.Services.Implementations
{
    public class ThemeService : IThemeService
    {
        ...
        public ThemeService(IConfiguration configuration, IRepositoryWithTypedId<AppSetting, string> appSettingRepository)
        {
            ...
            _currentThemeName = configuration[ExpressConstants.ThemeConfigKey];
        }
        ...
        {
            var themeSetting = await _appSettingRepository.Query().Where(x => x.Id == ExpressConstants.ThemeConfigKey).FirstAsync();
